    ...
    return (
        <div className="w-full min-h-[88vh] flex justify-center items-center">
            <Card className="mx-auto w-sm md:w-[700px] py-3 border-none">
                <CardHeader>
                    <CardTitle className="text-xl text-center">{newStaffPyaload?.firstName ? newStaffPyaload?.firstName : "" + " " + newStaffPyaload?.lastName}</CardTitle>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="grid gap-2">
                                    <Select onValueChange={handleSelectRoleChange}>
                                        ...
                                        <SelectTrigger className="w-full placeholder:text-gray-300">
                                            {newStaffPyaload?.role ? <SelectValue placeholder={newStaffPyaload?.role as string} /> : <SelectValue placeholder="Select..." />}
                                        </SelectTrigger>
                                        <SelectContent>
                                ...
                                <div className="grid gap-2">
                                    <Select onValueChange={handleSelectGenderChange}>
                                        ...
                                        <SelectTrigger className="w-full placeholder:text-gray-300">
                                            {newStaffPyaload?.gender ? <SelectValue placeholder={newStaffPyaload?.gender as string} /> : <SelectValue placeholder="Select..." />}
                                        </SelectTrigger>
                                        <SelectContent>
