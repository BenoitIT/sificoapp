...
const Page = () => {
  ...
  const [newShipperpayload, setStaffData] = useState<NewShipper>({});
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    if (shipperName.value === "") {
      ...
      newShipperpayload.phone &&
      !phoneRegx.test(newShipperpayload.phone)
    ) {
      ErrorLogger("phone", "Valid phone number is required.");
    } else {
      console.log("payload", newShipperpayload);
    }
  };
  return (
